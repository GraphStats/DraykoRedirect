    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.error) {
                ...
                setUrl('');
                setCustomId('');
                // We could just refresh but let's update state for better UX
                ...
                <div className="card">
                    ...
                    <form onSubmit={handleCreate}>
                        ...
                        <div className="input-group">
                            ...
                            />
                            <p className="hint">Laisse vide pour un code aléatoire</p>
                        </div>
            ...
            <section className="list-section">
                <div className="card">
                    ...
                    <div className="redirects-list">
                        {redirects.length === 0 ? (
                            <p className="empty">Aucun lien créé pour le moment.</p>
                        ) : (
                            redirects.map((r) => (
                                <div key={r.id} className="redirect-item">
                                    <div className="item-info">
                                        <div className="id-line">
                                            <span className="slug">/redirect/user/{r.id}</span>
